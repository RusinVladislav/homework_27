...
class UserCreatelView(CreateView):
    model = User
    fields = "__all__"
    ...
    def post(self, request, *args, **kwargs):
        ...
        new_user = User.objects.create(first_name=user_data.get["first_name"],
...
@method_decorator(csrf_exempt, name='dispatch')
class UserUpdatelView(UpdateView):
    model = User
    fields = "__all__"
...
@method_decorator(csrf_exempt, name='dispatch')
class UserDeletelView(DeleteView):
    model = User
    success_url = "/"
